...
public class GraveBlockEntity extends BlockEntity {
    ...
    private void updatePosition(ServerWorld world, BlockPos pos) {
        ...
        if (this.component.getStatus() == GraveStatus.DESTROYED || !this.claimed) {
            ...
            ProfileComponent owner = this.component.getOwner();
            ServerPlayerEntity player = owner.id().isPresent() ? playerManager.getPlayer(owner.id().get()) : playerManager.getPlayer(owner.name().orElse(null));
            if (player != null) {
