...
public class GraveSelectScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        textureManager.bindTexture(GRAVE_SELECT_TEXTURE);
        drawTexture(matrices, screenLeft, screenTop, 0, 0, screenWidth, screenHeight);

        textureManager.bindTexture(SELECT_ELEMENT_TEXTURE);
        ...
        for (int i = startValue; i > whileMoreThan; i--) {
            textureManager.bindTexture(SELECT_ELEMENT_TEXTURE); // If not present, gui bugs out
    ...
    private static class GuiGraveInfo {
        ...
        public GuiGraveInfo(DeadPlayerData data, int itemSize, int xpLevels) {
            this.data = data;
