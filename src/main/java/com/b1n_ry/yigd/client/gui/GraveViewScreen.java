...
public class GraveViewScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        textRenderer.draw(matrices, new TranslatableText("text.yigd.gui.grave_view.dim_name", dimName), textX, originY - screenHeight / 2f + 16, 0x0055c4);
        textRenderer.draw(matrices, data.gravePos.getX() + " " + data.gravePos.getY() + " " + data.gravePos.getZ(), textX, originY - screenHeight / 2f + 25f, 0xBB00BB);
